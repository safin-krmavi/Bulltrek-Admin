...
export default function Banner1() {
  ...
  const handleSave = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: call save API or parent callback
    setIsEditing(false);
  };
    ...
    <div className="bg-[#f7f7fb] min-h-[360px] rounded-lg">
      <div className="bg-white rounded-lg shadow-sm p-6 max-w-[1100px] mx-auto">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-[#222]">Banner 1</h3>
          <div className="text-sm text-gray-500">Create / edit your banner</div>
        </div>
